...
const AppointmentModifications: React.FC = () => {
  ...
  const openReschedule = (a: Appointment) => { setSelected(a); setRescheduleOpen(true); };
  const openCancel = (a: Appointment) => { setSelected(a); setCancelOpen(true); };
  const openModify = (a: Appointment) => { setSelected(a); setModifyOpen(true); };

  return (
    <div className="flex h-screen">
      <Sidebar />
      <div className="flex-1 flex flex-col">
        <HeaderBar pageTitle="Appointment Modifications" pageSubtitle="Reschedule, cancel or upgrade services" />
      ...
      <Drawer open={rescheduleOpen} onOpenChange={setRescheduleOpen}>
        <DrawerContent className="w-full md:max-w-lg ml-auto md:rounded-l-lg">
          ...
          <div className="p-4 space-y-4">
            <div className="border rounded h-64 flex items-center justify-center text-gray-400">Calendar & slots (TBD)</div>
      ...
      <Drawer open={modifyOpen} onOpenChange={setModifyOpen}>
        <DrawerContent className="w-full md:max-w-lg ml-auto md:rounded-l-lg">
          <DrawerHeader><DrawerTitle>Modify Appointment Services</DrawerTitle></DrawerHeader>
          <div className="p-4 space-y-4">
            <div className="border rounded h-40 flex items-center justify-center text-gray-400">Service checklist (TBD)</div>
            <div className="border rounded h-24 flex items-center justify-center text-gray-400">Price summary (TBD)</div>
...
export default AppointmentModifications;
